(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [517],
  {
        ...
        return (
          (0, a.useInsertionEffect)(() => {
            let { tree: e, pushRef: r, canonicalUrl: n } = t,
              o = { ...(r.preserveCustomHistoryState ? window.history.state : {}), __NA: !0, __PRIVATEnextJS_INTERNALS_TREE: e };
      ...
      function C(e) {
        ...
        (0, a.useEffect)(() => {
          ...
          (0, a.useEffect)(() => {
            function e(e) {
              var t;
              e.persisted && (null == (t = window.history.state) ? void 0 : t.__PRIVATEnextJS_INTERNALS_TREE) && ((S.pendingMpaPath = void 0), f({ type: l.ACTION_RESTORE, url: new URL(window.location.href), tree: window.history.state.__PRIVATEnextJS_INTERNALS_TREE }));
            }
            return (
        ...
        (0, a.useEffect)(() => {
          ...
          let n = (e) => {
            if (e.state) {
              ...
              (0, a.startTransition)(() => {
                f({ type: l.ACTION_RESTORE, url: new URL(window.location.href), tree: e.state.__PRIVATEnextJS_INTERNALS_TREE });
              });
            }
          };
          return (
    ...
    4091: (e, t, r) => {
      ...
      function h(e, t, r) {
        let o = new URL(e);
        o.pathname.endsWith("/") ? (o.pathname += "index.txt") : (o.pathname += ".txt");
